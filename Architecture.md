...
## Overview
The Loan Agreement Analyser is a specialized Retrieval-Augmented Generation (RAG) system with clause-boundary parsing, session-scoped vector databases, hybrid retrieval (dense + sparse), and quantitative benchmark evaluation.
...
graph TD
    ...
    subgraph Hybrid Retrieval Engine
        Retriever -->|Dense Search| Chroma[(Persistent ChromaDB)]
